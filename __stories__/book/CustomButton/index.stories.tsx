...
storiesOf('Book|CustomButton', module)
    ...
    () => {
      return (
        <div>
          ...
          <CustomButton text="bgColor Button" padding="5px 10px" bgColor="#fa005c"/>
        </div>
      )
    },
    // If you want to set the options for a specific story
    ...
    () => {
      return (
        <div>
          ...
          <CustomButton text="bgColor Button" padding="5px 10px" bgColor="#fa005c" color="white" />
        </div>
      )
    },
    // If you want to set the options for a specific story
    ...
    () => {
      return (
        <div>
          ...
          <CustomButton text="bgColor Button" padding="5px 10px" bgColor="#fa005c" color="white" hoverBG="#7b002d" hoverC="#fff" />
        </div>
      )
    },
    // If you want to set the options for a specific story
